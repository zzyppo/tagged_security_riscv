...
{"li",        "C",   "CD,0",  MATCH_C_LI, MASK_C_LI | MASK_RVC_IMM, match_rd_nonzero, INSN_ALIAS },
{"li",        "I",   "d,j",      MATCH_ADDI, MASK_ADDI | MASK_RS1, match_opcode,  INSN_ALIAS|WR_xd }, /* addi */
{"li",        "I",   "d,I",  0,    (int) M_LI,  match_never, INSN_MACRO },
{"mv",        "C",   "CD,CT",  MATCH_C_MV, MASK_C_MV, match_rd_nonzero, INSN_ALIAS },
{"mv",        "I",   "d,s",  MATCH_ADDI, MASK_ADDI | MASK_IMM, match_opcode,   INSN_ALIAS|WR_xd|RD_xs1 },
{"move",      "C",   "CD,CT",  MATCH_C_MV, MASK_C_MV, match_rd_nonzero, INSN_ALIAS },
...
{"flw",       "32C", "FD,Cm(Cc)",  MATCH_C_FLWSP, MASK_C_FLWSP, match_rd_nonzero, INSN_ALIAS },
{"flw",       "32C", "Ft,Ck(Cs)",  MATCH_C_FLW, MASK_C_FLW, match_opcode, INSN_ALIAS },
{"flw",       "F",   "D,o(s)",  MATCH_FLW, MASK_FLW, match_opcode,   WR_fd|RD_xs1 },
{"flw",       "F",   "D,A,s",  0, (int) M_FLW, match_never,  INSN_MACRO },
{"fsw",       "32C", "FV,CM(Cc)",  MATCH_C_FSWSP, MASK_C_FSWSP, match_opcode, INSN_ALIAS },
{"fsw",       "32C", "Ft,Ck(Cs)",  MATCH_C_FSW, MASK_C_FSW, match_opcode, INSN_ALIAS },
...
{"fld",       "C",   "FD,Cn(Cc)",  MATCH_C_FLDSP, MASK_C_FLDSP, match_rd_nonzero, INSN_ALIAS },
{"fld",       "C",   "Ft,Cl(Cs)",  MATCH_C_FLD, MASK_C_FLD, match_opcode, INSN_ALIAS },
{"fld",       "D",   "D,o(s)",  MATCH_FLD, MASK_FLD, match_opcode,  WR_fd|RD_xs1 },
{"fld",       "D",   "D,A,s",  0, (int) M_FLD, match_never,  INSN_MACRO },
{"fsd",       "C",   "FV,CN(Cc)",  MATCH_C_FSDSP, MASK_C_FSDSP, match_opcode, INSN_ALIAS },
{"fsd",       "C",   "Ft,Cl(Cs)",  MATCH_C_FSD, MASK_C_FSD, match_opcode, INSN_ALIAS },
...
{"c.fldsp",   "C",   "FD,Cn(Cc)",  MATCH_C_FLDSP, MASK_C_FLDSP, match_rd_nonzero, 0 },
{"c.fld",     "C",   "Ft,Cl(Cs)",  MATCH_C_FLD, MASK_C_FLD, match_opcode, 0 },
{"c.fsdsp",   "C",   "FV,CN(Cc)",  MATCH_C_FSDSP, MASK_C_FSDSP, match_opcode, 0 },
{"c.fsd",     "C",   "Ft,Cl(Cs)",  MATCH_C_FSD, MASK_C_FSD, match_opcode, 0 },
{"c.flwsp",   "32C", "FD,Cm(Cc)",  MATCH_C_FLWSP, MASK_C_FLWSP, match_rd_nonzero, 0 },
{"c.flw",     "32C", "Ft,Ck(Cs)",  MATCH_C_FLW, MASK_C_FLW, match_opcode, 0 },
{"c.fswsp",   "32C", "FV,CM(Cc)",  MATCH_C_FSWSP, MASK_C_FSWSP, match_opcode, 0 },
{"c.fsw",     "32C", "Ft,Ck(Cs)",  MATCH_C_FSW, MASK_C_FSW, match_opcode, 0 },
