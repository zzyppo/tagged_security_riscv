...
object CSRs {
  ...
  val mimpid = 0xf01
  val mhartid = 0xf10
  val mtohost = ptohost // PCR
  val mfromhost = pfromhost // PCR
  val mreset = preset // PCR
  val send_ipi = 0x783
  val cycleh = 0xc80
  val timeh = 0xc81
  val instreth = 0xc82
  ...
  // Memory mapping control 0x7A0 - 0x7AE  maximal 4 sections, 3 regs/section
  // cbase(0), mask(1), mbase(2)
  // 0x7AF update

  // IO mapping control 0x7B0 - 0x7BE maximal 4 sections, 2 regs/section
  // cbase(0), mask(1)
  // 0x7BF update
