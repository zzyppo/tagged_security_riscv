...
#define CAUSE_TAG_TRAP      0xc
#define CAUSE_DEBUG_TAG_TRAP 0xd
#endif
#ifdef DECLARE_INSN
...
DECLARE_CSR(ptagctrl, CSR_PTAG_CTRL)
#endif
#ifdef DECLARE_CAUSE
...
DECLARE_CAUSE("tag_trap", CAUSE_TAG_TRAP)
DECLARE_CAUSE("debug_tag_trap", CAUSE_DEBUG_TAG_TRAP)
#endif
